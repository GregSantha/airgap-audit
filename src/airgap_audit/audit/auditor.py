...
class ElfAuditor:
    ...
    def _check_nx(self, elf: ELFFile) -> tuple[bool, MitigationCheck]:
        ...
        return True, MitigationCheck(
            ...
            cwe_id="CWE-119",
            summary="Stack is non-executable (NX enabled). Arbitrary code injection into stack blocked.",
        ...
        if e_type == "ET_DYN":
            ...
            if has_debug:
                return PieLevel.FULL_PIE, MitigationCheck(
                    ...
                    severity=Severity.INFO,
                    cwe_id="CWE-119",
                    summary="Full Position Independent Executable (PIE). ASLR fully operational.",
    ...
    def _check_canary(self, elf: ELFFile) -> tuple[bool, MitigationCheck]:
        ...
        if canary_found:
            return True, MitigationCheck(
                ...
                severity=Severity.INFO,
                cwe_id="CWE-121",
                summary="Stack canary symbols detected. Stack smashing triggers immediate termination.",
    ...
    def _check_relro(self, elf: ELFFile) -> tuple[RelroLevel, MitigationCheck]:
        ...
        if bind_now:
            return RelroLevel.FULL, MitigationCheck(
                ...
                severity=Severity.INFO,
                cwe_id="CWE-123",
                summary="Full RELRO enabled. GOT is populated at startup and marked read-only.",
